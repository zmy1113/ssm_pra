    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("button.addToCart").click(function () {
                ...
                $.get("http://localhost:8080/Book/cartServlet","action=ajaxAddItem&id="+bookId,function (data){
...
<div id="header">
    ...
    <div>
        ...
        <c:if test="${not empty sessionScope.user}">
            <span>欢迎<span class="um_span">${sessionScope.user.username}</span>光临shucheng书城</span>
            <a href="manager/orderServlet?action=myOrders">我的订单</a>
            <a href="userServlet?action=logout">注销</a>&nbsp;&nbsp;
        </c:if>

        <a class="cart" href="pages/cart/cart.jsp">购物车</a>
